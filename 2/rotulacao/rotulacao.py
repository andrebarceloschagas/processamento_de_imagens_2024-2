...
def save_binary_matrix(binary_image, output_path):
    ...
    binary_image = np.where(binary_image == 0, 'I', '*')
...
if __name__ == '__main__':
    # Carrega a imagem.
    input_path = '/mnt/3ACCDBA5CCDB59A9/one/UFT/disciplinas/8_periodo/3_processamento_de_imagens/codigos/2/rotulacao/18_redux.png'
    ...
    output_image_path = '/mnt/3ACCDBA5CCDB59A9/one/UFT/disciplinas/8_periodo/3_processamento_de_imagens/codigos/2/rotulacao/label_image.png'
    save_binary_image(binary_image, output_image_path)

    # Salva a matriz binária em um arquivo de texto.
    output_matrix_path = '/mnt/3ACCDBA5CCDB59A9/one/UFT/disciplinas/8_periodo/3_processamento_de_imagens/codigos/2/rotulacao/binary_matrix.txt'
...
def save_binary_matrix(binary_image, output_path):
    binary_image = np.where(binary_image == 0, '$', '*')
    np.savetxt(output_path, binary_image, fmt='%s')
...
if __name__ == '__main__':
    input_path = '/run/media/andre/arquivos/oneDrive/UFT/disciplinas/8_periodo/3_processamento_de_imagens/codigos/2/rotulacao/18_redux.png'

    binary_image = to_binary_image(input_path)

    labeled_image = label_objects(binary_image)

    output_image_path = '/run/media/andre/arquivos/oneDrive/UFT/disciplinas/8_periodo/3_processamento_de_imagens/codigos/2/rotulacao/binary_image.png'
    save_binary_image(binary_image, output_image_path)

    output_matrix_path = '/run/media/andre/arquivos/oneDrive/UFT/disciplinas/8_periodo/3_processamento_de_imagens/codigos/2/rotulacao/binary_matrix.txt'
    save_binary_matrix(binary_image, output_matrix_path)
