...
def nearest_neighbor_interpolation(pixels, new_size):
    ...
    if len(pixels.shape) == 2:
        # Adicionar um canal extra para imagens em escala de cinza
...
if __name__ == '__main__':
    ...
    file_path = "/run/media/andre/arquivos/oneDrive/UFT/disciplinas/8_periodo/3_processamento_de_imagens/codigos/1/reducao_vizinho/imagem.jpg"
    ...
    # Redimensionando a imagem utilizando a interpolação por vizinho mais próximo
    ...
    save_image(new_image, "/run/media/andre/arquivos/oneDrive/UFT/disciplinas/8_periodo/3_processamento_de_imagens/codigos/1/reducao_vizinho/new_image.jpg")
